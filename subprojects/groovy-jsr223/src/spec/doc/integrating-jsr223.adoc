...
== How to use the JSR-223 API to execute Groovy scripts from Java
...
`groovy.jsr223.option.configscript`:: this option takes as argument the name of a file that uses a
`CompilerCustomizationBuilder` to control the behavior of the Groovy compiler.
`groovy.jsr223.option.basescript`:: this option takes as argument the fully-qualified name of a *class* (which
